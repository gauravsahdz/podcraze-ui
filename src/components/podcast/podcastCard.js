...
const PodcastCard = ({ podcastData, protect, openModalDialog,onPodcastSelect }) => {
    ...
    const handlePlayPodcast = () => {
        const selectedPodcast = podcastData;
        ...
        <Card className="podcast-card mb-3">
            <div className="card-img-container">
                ...
                <div className="play-overlay">
                    <FontAwesomeIcon icon={faPlayCircle} className="play-icon" onClick={handlePlayPodcast} />
                </div>
            </div>
            <Card.Body>
                ...
                <Card.Subtitle className="mb-2 host">
                    {podcastData.host}
                </Card.Subtitle>
