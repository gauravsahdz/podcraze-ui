...
const LandingPage = () => {
    ...
    const image_link = 'https://st2.depositphotos.com/1006899/8421/i/600/depositphotos_84219350-stock-photo-word-blog-suspended-by-ropes.jpg';
    ...
    const fetchPodcasts = async () => {
        try {
            ...
            setAlert({ variant: "danger", message: error.response.data.message, show: true });
        }
    };
        ...
        <Container className='landing-container'>
            <Row className='header'>
                <Col className="col1" sm={8}>
                    <h1>Discover a world of captivating podcasts with PodCraze – your ultimate destination for immersive audio experiences.</h1>
            ...
            <Row className='blogs-section podcast-row'>
                ...
                <Col sm={8} className="col1">
                    <Card className="blog-card">
                        <Card.Body>
                            <Card.Img variant="top" src={image_link} alt={title} className="card-img" />
